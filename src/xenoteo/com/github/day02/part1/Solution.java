...
public class Solution {
     ...
     *
     * Iterates over the list of moves and updates the current horizontal position and the depth.
     *
    ...
    public long findMultiplicationOfFinalPositions(List<Move> moves) {
        ...
        for (Move move : moves) {
            switch (move.direction) {
                ...
                case forward -> horizontal += move.value;
            }
        }
